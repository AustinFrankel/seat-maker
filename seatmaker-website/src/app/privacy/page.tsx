    ...
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10 md:py-16">
      ...
      <div className="text-sm text-muted-foreground space-y-6">
        ...
        <div className="space-y-6">
          ...
          <p>
            This Privacy Notice for Seat Maker ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
          </p>
          
          <ul className="list-disc pl-6 space-y-2">
            <li>Download and use our mobile application (Seat Maker), or any other application of ours that links to this Privacy Notice</li>
            <li>Use Seat Maker. Seat Maker is designed to plan seating for parties, events, and special occasions. Whether you are organizing a wedding, dinner party, bar/bat mitzvahs, or corporate event, Seat Maker helps you design a complete seating layout in just a few taps. Build your space by choosing from round, square, or rectangular tables. Add as many tables and guests as you need. Drag and drop guests into place, rearrange tables to fit your layout, and tap the Shuffle button to automatically generate new seating combinations. You can group guests, assign names or avatars, and experiment freely until the setup feels right. Table Maker is designed for speed, simplicity, and flexibility. Move things around with ease and make changes on the fly. Customize table names, colors, and seating arrangements to match your style, theme, or venue. When your event is ready you can share using a QR code Messages, or email. Everything works offline with no account or internet connection required. Your data stays on your device, giving you full privacy and control at all times. The app supports accessibility features including VoiceOver, Dynamic Type, and dark mode, so everyone can use it comfortably. Table Maker is made for iPhone and designed to feel fast, responsive, and easy to use.</li>
          ...
          <p>
            ...
            <a href="mailto:tablemakercontact@gmail.com" className="underline text-blue-600 hover:text-blue-800">
              tablemakercontact@gmail.com
            </a>.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <h3 className="text-lg font-medium text-foreground">Personal information you disclose to us</h3>
          ...
          <p><strong>Mobile Device Access.</strong> We may request access or permission to certain features from your mobile device, including your mobile device's contacts, sms messages, camera, and other features. If you wish to change our access or permissions, you may do so in your device's settings.</p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">7. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
          <p><strong>In Short:</strong> Depending on your state of residence in the US or in some regions, such as the European Economic Area (EEA), United Kingdom (UK), Switzerland, and Canada, you have certain rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time, depending on your country, province, or state of residence.</p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">8. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">9. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
          ...
          <h3 className="text-lg font-medium text-foreground">Categories of Personal Information We Collect</h3>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>Category B - Never</li>
            <li>Category H - Never</li>
          </ul>
          
          <h3 className="text-lg font-medium text-foreground">Sources of Personal Information</h3>
          <p>Learn more about the sources of personal information we collect in "WHAT INFORMATION DO WE COLLECT?"</p>
          
          <h3 className="text-lg font-medium text-foreground">How We Use and Share Personal Information</h3>
          ...
          <h3 className="text-lg font-medium text-foreground">Request Verification</h3>
          <p>
          ...
          <h3 className="text-lg font-medium text-foreground">Appeals</h3>
          <p>
          ...
          <h3 className="text-lg font-medium text-foreground">California "Shine The Light" Law</h3>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">10. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
          <p><strong>In Short:</strong> You may have additional rights based on the country you reside in.</p>
          
          <h3 className="text-lg font-medium text-foreground">Australia and New Zealand</h3>
          <p>
          ...
          <h3 className="text-lg font-medium text-foreground">Republic of South Africa</h3>
          <p>
            At any time, you have the right to request access to or correction of your personal information. You can make such a request by contacting us by using the contact details provided in the section "HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?"
          </p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">11. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
          <p>
