  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 md:py-16">
      <div className="text-center">
        <h1 className="text-3xl font-semibold tracking-tight mb-4">Download Seat Maker</h1>
        <p className="text-muted-foreground mb-6">iPhone & iPad · iOS/iPadOS 16+ · Light/Dark mode</p>
        <div className="flex items-center justify-center gap-6">
          <AppStoreBadge />
          <div className="rounded-xl bg-white p-4 shadow-sm border">
            {/* No event handlers on server components */}
            <QRCode value={appStoreUrl} size={180} aria-label="QR code to download Seat Maker" />
          </div>
        </div>
        <div className="text-sm text-muted-foreground mt-6">We auto-detect your store region.</div>
      </div>
    </div>
  );
}
