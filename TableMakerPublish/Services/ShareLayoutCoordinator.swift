...
final class ShareLayoutCoordinator: ObservableObject {
    ...
    private static func decodeFragment(_ fragment: String) throws -> Data {
        // Parse v and d
    ...
    private static func fetchSnapshot(slug: String, base: URL) async throws -> Data {
        var comps = URLComponents()
    ...
    private static func arrangement(fromSnapshot data: Data) throws -> SeatingArrangement {
